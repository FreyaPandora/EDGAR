...
def decision_tree_regressor(predict_target, sentiment_list):
    ...
    model = DecisionTreeRegressor(max_depth = 10, min_samples_leaf = 0.03, random_state = 3)
